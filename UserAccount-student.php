        ...
        <div class="container">
                        ...
                        <div class="modal-body" id="modal-body">
                            <form method="GET" id="search-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="search-field" class="form-control" name="search">
                                </div>
                            </form>
                            <button type="button" id="search-button" class="btn btn-warning text-white">Search</button>
                        </div>
            ...
            <table id="editable" class="table table-bordered" border: 1px solid black; width:100%; vertical-align:
                ...
                <tbody>
                    ...
                    $query = "SELECT * FROM `student` WHERE `id`='$session_user'";
            ...
            <button type="button" class="btn btn-primary float-left"
                onclick="window.location.href='./individual-timetable.php'">timetable</button>
            <!-- Add Modal -->
