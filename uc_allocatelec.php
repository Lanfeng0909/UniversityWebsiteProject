...
if ($session_position=="student") {
    ?>
        ...
        <a href="./Masterpage_uc.php" class="navbar nav-font-white">UC/DC Management</a>
        <?php
}else{
        ?>
        <a href="./unit-details.php" class="navbar nav-font-white">Unit Details</a>
...
<!-- add lecturer and consultation time-->
        <?php
